...
func (*FlatConfig) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
		...
		"parameter-name":             &hcldec.AttrSpec{Name: "parameter-name", Type: cty.String, Required: false},
		"encrypt":                    &hcldec.AttrSpec{Name: "encrypt", Type: cty.Bool, Required: false},
		"region":                     &hcldec.AttrSpec{Name: "region", Type: cty.String, Required: false},
		"overwrite":                  &hcldec.AttrSpec{Name: "overwrite", Type: cty.Bool, Required: false},
		"matcher":                    &hcldec.AttrSpec{Name: "matcher", Type: cty.String, Required: false},
	}
	return s
}
